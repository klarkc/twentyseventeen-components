!function(root, factory) {
    ...
    return function(modules) {
        ...
        function forEach(obj, fn) {
            if (null !== obj && void 0 !== obj) if ("object" != typeof obj && (obj = [ obj ]), isArray(obj)) for (var i = 0, l = obj.length; i < l; i++) fn.call(null, obj[i], i, obj); else for (var key in obj) Object.prototype.hasOwnProperty.call(obj, key) && fn.call(null, obj[key], key, obj);
        }
        function merge() {
        ...
        module.exports = function(rawScriptExports, compiledTemplate, functionalTemplate, injectStyles, scopeId, moduleIdentifier) {
            ...
            compiledTemplate && (options.render = compiledTemplate.render, options.staticRenderFns = compiledTemplate.staticRenderFns, options._compiled = !0), functionalTemplate && (options.functional = !0), scopeId && (options._scopeId = scopeId);
            var hook;
            if (moduleIdentifier ? (hook = function(context) {
                context = context || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext, context || "undefined" == typeof __VUE_SSR_CONTEXT__ || (context = __VUE_SSR_CONTEXT__), injectStyles && injectStyles.call(this, context), context && context._registeredComponents && context._registeredComponents.add(moduleIdentifier);
        ...
        (function(process) {
            ...
            var utils = __webpack_require__(0), normalizeHeaderName = __webpack_require__(27), DEFAULT_CONTENT_TYPE = {
                ...
                adapter: function() {
                    var adapter;
                    return "undefined" != typeof XMLHttpRequest ? adapter = __webpack_require__(9) : void 0 !== process && (adapter = __webpack_require__(9)), adapter;
                }(),
        ...
        __webpack_exports__.a = {
            ...
            methods: {
                ...
                signUser: function(data) {
                    var _this = this;
                    this.idToken = data[0], this.userId = data[1], this.userName = data[2], this.expiresIn = data[3], this.logOutTimer = setTimeout(function() {
                        _this.clearAuth();
                    }, 1e3 * this.expiresIn), this.isAdmin = data[4], this.auth = !0, this.showSignPanel = !1;
                },
                clearAuth: function() {
                    clearTimeout(this.logOutTimer), this.idToken = "", this.userId = "", this.userName = "", this.isAdmin = null, this.auth = !1, localStorage.removeItem("commentToken"), localStorage.removeItem("commentUserId"), localStorage.removeItem("commentExpirationDate"), localStorage.removeItem("commentUserName"), localStorage.removeItem("commentAdmin");
                },
                updateLimit: function() {
                    this.limit += parseInt(this.initialMessageLimit);
                },
                resize: function(event) {
                    "" == this.newComment ? (this.$refs.addComment.style.height = "auto", this.$refs.addComment.style.height = "32px") : (event.target.style.height = "auto", event.target.style.height = event.target.scrollHeight + "px");
                },
                addComment: function() {
                    var _this2 = this;
                    if (this.auth) if (0 != this.filterNewComment) {
                        ...
                        __WEBPACK_IMPORTED_MODULE_2_axios___default.a.post(this.baseURL + "/commentsGrid/" + this.nodeName + "/comments.json?auth=" + this.idToken, commentObj).then(function(res) {
                            ...
                            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.put(_this2.baseURL + "/commentsGrid/" + _this2.nodeName + "/replys/" + commentObj.id + ".json?auth=" + _this2.idToken, repliedObj).then(function(res) {
                                commentObj.depth = "commentsGrid/" + _this2.nodeName + "/comments/" + commentObj.id, _this2.comments.splice(0, 0, commentObj), _this2.clearAlert(), _this2.newComment = "", _this2.resize();
                            }).catch(function(err) {
                ...
                setAlert: function(message, style, type) {
                    var _this3 = this;
                    "append" == type ? this.alertMessage += message : this.alertMessage = message, this.alertClass = style, this.alert = !0, this.requestLoading = !1, setTimeout(function() {
                        _this3.clearAlert();
                    }, 5e3);
                },
                clearAlert: function() {
            ...
            created: function() {
                ...
                this.checkAutoLogin(), __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get(this.baseURL + "/commentsGrid/" + this.nodeName + "/comments.json").then(function(res) {
                    ...
                    for (var key in data) {
                        ...
                        comment.id = key, comment.depth = "commentsGrid/" + _this5.nodeName + "/comments/" + comment.id, _this5.comments.unshift(comment);
                    }
                    _this5.loading = !1;
                }).catch(function(err) {
        ...
        __webpack_exports__.a = {
            ...
            methods: {
                ...
                resize: function(event, from) {
                    event.target.style.height = "auto", event.target.style.height = event.target.scrollHeight + "px", from ? "" == this.updateMessage && 32 != this.$refs.addUpdate.style.height && (this.$refs.addUpdate.style.height = "32px") : "" == this.replyMessage && 32 != this.$refs.addReply.style.height && (this.$refs.addReply.style.height = "32px");
                },
                handleBeforeReply: function() {
                    var _this = this;
                    if (this.clearAlert(), this.beforeReply = !this.beforeReply, !this.svgAvatarCheck) {
                        for (var a = void 0, b = void 0, c = void 0, d = 0, i = 0; i < 10; i++) a = Math.floor(25 * Math.random()) + 10, b = Math.floor(30 * Math.random()) + 5, c = Math.floor(30 * Math.random()) + 5, d = Math.floor(5 * Math.random()) + 0, this.$refs.svgReplyAvatar.innerHTML += "<circle cx=" + (Math.floor(30 * Math.random()) + 5) + " cy=" + (Math.floor(30 * Math.random()) + 5) + " r='" + Math.round(15 * Math.random()) + "' fill='rgba(" + Math.round(244 * Math.random()) + "," + Math.round(244 * Math.random()) + "," + Math.round(244 * Math.random()) + "," + Math.random() + ")'> <animate  attributeName=cx attributeType=XML dur=" + (Math.floor(4 * Math.random()) + 3) + "s values='" + a + " ; " + b + " ; " + a + " ; " + c + " ; " + a + "' keyTimes='0 ; 0.25 ; 0.5 ; 0.75 ; 1' repeatCount=indefinite></animate><animate attributeName=cy attributeType=XML dur=" + (Math.floor(4 * Math.random()) + 3) + "s values='" + c + "; " + a + "; " + b + " ; " + a + " ; " + c + "' keyTimes='0 ; 0.25 ; 0.5 ; 0.75 ; 1' repeatCount=indefinite></animate><animate attributeName=r values='" + d + " ; " + 15 * Math.random() + " ; " + 15 * Math.random() + " ; " + 15 * Math.random() + " ; " + d + "' keyTimes='0 ; 0.25 ; 0.5 ; 0.75 ; 1' dur='" + (Math.floor(4 * Math.random()) + 3) + "s' repeatCount=indefinite></animate></circle>";
                    ...
                    if (this.auth) if (0 != this.filterNewComment.length) {
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(this.baseURL + "/commentsGrid/" + this.nodeName + "/replys/" + this.id + ".json?auth=" + this.idToken, replyObj).then(function(res) {
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put(_this2.baseURL + "/commentsGrid/" + _this2.nodeName + "/replys/" + replyObj.id + ".json?auth=" + _this2.idToken, repliedObj).then(function(res) {
                                replyObj.depth = "commentsGrid/" + _this2.nodeName + "/replys/" + _this2.id + "/" + replyObj.id, _this2.replys.splice(0, 0, replyObj), _this2.replyMessage = "", _this2.$refs.addReply.style.height = "32px", _this2.beforeReply = !_this2.beforeReply, _this2.replied || (_this2.replied = !0, _this2.showReplies || (_this2.showReplies = !_this2.showReplies)), _this2.clearAlert();
                            }).catch(function(err) {
                                return _this2.setAlert("Unauthorized!\n", "fail");
                            });
                        }).catch(function(err) {
                ...
                handleBeforeUpdate: function() {
                    var _this3 = this;
                    this.beforeReply = !1, this.beforeUpdate = !0, this.updateMessage = this.filteredComment, this.$refs.addUpdate.style.height = this.updateHeight + "px", this.$nextTick(function() {
                ...
                update: function() {
                    ...
                    if (this.auth) if (this.requestLoading = !0, this.isAdmin) if (0 != this.filterNewUpdate.length) {
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.patch(this.baseURL + "/" + this.depth + ".json?auth=" + this.idToken, _replyObj).then(function(res) {
                            _this4.clearAlert(), _this4.filteredComment = _this4.filterNewUpdate, _this4.afterUpdate(), setTimeout(function() {
            ...
            created: function() {
                var _this9 = this;
                if (this.depthFromReplies = this.depth + "/" + this.id + "/reply", this.depthLength < +this.maxShowingDepth && (this.showReplies = !0), __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(this.baseURL + "/commentsGrid/" + this.nodeName + "/replys/" + this.id + ".json").then(function(res) {
                    var data = res.data;
                    for (var key in data) if (key.startsWith("-")) {
                        var reply = data[key];
                        reply.id = key, reply.depth = "commentsGrid/" + _this9.nodeName + "/replys/" + _this9.id + "/" + reply.id, _this9.replys.unshift(reply);
        ...
        __webpack_exports__.a = {
            ...
            methods: {
                signUp: function(event) {
                    var _this = this;
                    event && event.preventDefault(), this.alertMessage = "", "pass" != this.checkNewUserName && (this.$refs.namePlaceholder.classList.remove("shake"), setTimeout(function() {
                        _this.$refs.namePlaceholder.className += " shake";
                    }, 1)), "pass" != this.checkNewUserEmail && (this.$refs.emailPlaceholder.classList.remove("shake"), setTimeout(function() {
                        _this.$refs.emailPlaceholder.className += " shake";
                    }, 1)), "pass" != this.checkNewUserPassword && (this.$refs.passPlaceholder.classList.remove("shake"), setTimeout(function() {
                        _this.$refs.passPlaceholder.className += " shake";
                    }, 1)), "pass" != this.checkNewUserRePassword && (this.$refs.rePassPlaceholder.classList.remove("shake"), setTimeout(function() {
                        ...
                        _this.idTokenD = res.data.idToken, _this.userIdD = res.data.localId, _this.expiresInD = res.data.expiresIn, __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put(_this.baseURL + "/commentUsers/" + res.data.localId + ".json?auth=" + res.data.idToken, {
                            ...
                            _this.signUser(data), _this.setLocalStorageItems(_this.idTokenD, _this.userIdD, _this.expiresInD, _this.filterNewUserName), _this.clearAlert(), _this.clearSignPanel();
                        }).catch(function(err) {
                ...
                signIn: function(event) {
                    ...
                    event && event.preventDefault(), this.requestLoading = !0, INSTANCE.post("/verifyPassword?key=" + this.apiKey, {
                        ...
                        _this2.idTokenD = res.data.idToken, _this2.userIdD = res.data.localId, _this2.expiresInD = res.data.expiresIn, __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(_this2.baseURL + "/commentUsers/" + res.data.localId + ".json?auth=" + res.data.idToken).then(function(res) {
                            var data = [ _this2.idTokenD, _this2.userIdD, res.data.name, _this2.expiresInD, res.data.admin ];
                            _this2.signUser(data), _this2.setLocalStorageItems(_this2.idTokenD, _this2.userIdD, _this2.expiresInD, res.data.name, res.data.admin), _this2.clearAlert(), _this2.clearSignPanel();
                        }).catch(function(err) {
                            return _this2.setAlert("Unauthorized!\n", "fail");
                        });
                    }).catch(function(err) {
                ...
                clearSignPanel: function() {
                    this.showSignPanel = !1, this.signInBox = !1, this.signUpBox = !1, this.userEmail = "", this.userPassword = "", this.newUserName = "", this.newUserEmail = "", this.newUserPassword = "", this.newUserRePassword = "";
                },
                ...
                setLocalStorageItems: function(token, userId, expDate, userName, admin) {
                    ...
                    localStorage.setItem("commentToken", token), localStorage.setItem("commentUserId", userId), localStorage.setItem("commentExpirationDate", expirationDate), localStorage.setItem("commentUserName", userName), localStorage.setItem("commentAdmin", admin);
                }
            },
            computed: {
        ...
        }, axios.Cancel = __webpack_require__(12), axios.CancelToken = __webpack_require__(40), axios.isCancel = __webpack_require__(11), axios.all = function(promises) {
